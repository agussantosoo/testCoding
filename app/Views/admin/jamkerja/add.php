      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <form id="frm-add" method="post" action="<?= base_url('jamkerja/create') ?>">
                      ...
                      <select class="form-control" name="hari" required>
                        ...
                        <?php
                          foreach (json_decode($dt_hari) as $hr) {
                            echo '<option value="'.$hr->id.'">'.$hr->nama.'</option>';
                          }
                        ?>
                      </select>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="inputtimemasuk" data-target-input="nearest">
                          <input type="text" name="jam_masuk" required class="form-control datetimepicker-input" data-target="#inputtimemasuk" data-toggle="datetimepicker" value="<?= date("H:i") ?>"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="inputtimekeluar" data-target-input="nearest">
                          <input type="text" name="jam_keluar" required class="form-control datetimepicker-input" data-target="#inputtimekeluar" data-toggle="datetimepicker" value="<?= date("H:i") ?>"/>
