          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <a href="<?= base_url('jamkerja/tambah') ?>" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Tambah</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('#table-data').DataTable({
                ...
                "order": [],
                "ajax": {
                    "url": "<?= base_url('jamkerja/datatables') ?>",
                    "type": "POST"
                },
                "columnDefs": [{
                    "targets": [0,4],
